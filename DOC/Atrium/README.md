...
- [Activation d'Atrium](activation.md)
- [Suivi de la consommation et des quotas](quotas.md)
- [Message d'accueil](message-accueil.md)
- [Comportement de l'IA](comportement-ia.md)
- [Base de connaissances](base-de-connaissances.md)

Les réglages décrits ici s'appliquent au serveur Discord sélectionné.
