//! Cycle de vie des conteneurs de jeu — ré-exportation du port `ops-core`.
//!
...
//! `docker-agent`.
//!
//! Le port vit maintenant dans `ops-core` (domaine neutre de la machine hôte),
...
pub use ops_core::domain::entities::game_runtime::{
...
pub use ops_core::ports::outbound::game_runtime::GameContainerRuntime as ContainerRuntime;
