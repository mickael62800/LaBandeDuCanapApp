...
use crate::ports::inbound::manage_server_events::ManageServerEventsUseCase;
use crate::ports::outbound::server_event_repository::ServerEventRepository;
...
impl ManageServerEventsUseCase for ManageServerEventsService {
    ...
    async fn list(
        ...
        let limit = limit
            .unwrap_or(100)
            .clamp(1, crate::application::PAGE_LIMIT_MAX);
        self.repo
