...
INSERT INTO public.bot_definitions VALUES ('nasa-apod-bot', 'Photo de l''espace (NASA)', 'Publie chaque jour l''Astronomy Picture of the Day de la NASA dans un salon. Traduction FR optionnelle via DeepL.', '[{"key": "enabled", "type": "boolean", "label": "Bot actif", "default": "false", "required": false, "description": "Active la publication quotidienne de la photo du jour."}, {"key": "channel_id", "type": "channel", "label": "Salon de publication", "default": "", "required": true, "description": "Salon textuel où poster la photo de l''espace chaque jour."}, {"key": "nasa_api_key", "type": "text", "label": "Clé API NASA", "default": "", "required": true, "description": "Clé gratuite à créer sur api.nasa.gov. Obligatoire."}, {"key": "deepl_api_key", "type": "text", "label": "Clé API DeepL (traduction FR)", "default": "", "required": false, "description": "Clé DeepL pour traduire titre et explication en français. Vide = texte original en anglais."}, {"key": "post_hour", "type": "number", "label": "Heure de publication (0-23)", "default": "9", "required": false, "description": "Heure quotidienne de publication, dans le fuseau choisi ci-dessous."}, {"key": "timezone_offset", "type": "number", "label": "Décalage horaire vs UTC", "default": "1", "required": false, "description": "Décalage du fuseau du serveur : Paris = 1 en hiver, 2 en été. 0 = UTC."}]');
