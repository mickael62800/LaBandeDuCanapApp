-- Ajout des parametres AFK auto-move pour voice-bot
UPDATE bot_definitions SET config_schema = '[
    ...
    {"key": "afk_enabled", "label": "Activer le deplacement AFK automatique", "type": "boolean", "required": false, "default": "false"},
    {"key": "afk_channel_id", "label": "Salon AFK de destination", "type": "channel", "required": false},
    {"key": "afk_timeout_minutes", "label": "Delai AFK avant deplacement (minutes)", "type": "number", "required": false, "default": "10"},
    {"key": "afk_move_owner", "label": "Deplacer aussi le proprietaire du salon", "type": "boolean", "required": false, "default": "false"},
