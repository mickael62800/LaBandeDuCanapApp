-- Migration 114 : corriger le label de join_leave_channel_id
--
-- Les ban/unban ne sont plus postes dans ce salon (doublon avec le
-- moderation-bot qui a son propre log_channel_id). Le salon sert
-- desormais uniquement aux arrivees et departs volontaires.
...
SET config_schema = '[
    ...
    {"key": "join_leave_channel_id", "label": "Salon entrees/sorties (join, leave)", "type": "channel", "required": false, "default": ""},
