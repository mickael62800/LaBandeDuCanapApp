...
const KNOWLEDGE: &[KnowledgeDocument] = &[
    KnowledgeDocument {
        ...
        content: include_str!("../../knowledge/atrium/Reglement_La_Bande_du_Canape.md"),
    },
    KnowledgeDocument {
        title: "Les règles du canapé",
        source: "knowledge://les-regles-du-canape.md",
        content: include_str!("../../knowledge/atrium/les-regles-du-canape.md"),
    },
    KnowledgeDocument {
        title: "S.O.S canapé",
        source: "knowledge://sos-canape.md",
        content: include_str!("../../knowledge/atrium/sos-canape.md"),
    },
    KnowledgeDocument {
        title: "Créer ton canapé",
        source: "knowledge://cree-ton-canape.md",
        content: include_str!("../../knowledge/atrium/cree-ton-canape.md"),
    },
    KnowledgeDocument {
        title: "Canapé vocal",
        source: "knowledge://canape-vocal.md",
        content: include_str!("../../knowledge/atrium/canape-vocal.md"),
    },
    KnowledgeDocument {
        title: "Autour du canapé",
        source: "knowledge://autour-du-canape.md",
        content: include_str!("../../knowledge/atrium/autour-du-canape.md"),
    },
    KnowledgeDocument {
        title: "Choisis ton jeu",
        source: "knowledge://choisis-ton-jeu.md",
        content: include_str!("../../knowledge/atrium/choisis-ton-jeu.md"),
    },
    KnowledgeDocument {
        title: "Table de blackjack",
        source: "knowledge://table-de-blackjack.md",
        content: include_str!("../../knowledge/atrium/table-de-blackjack.md"),
    },
    KnowledgeDocument {
        title: "La roue du canapé",
        source: "knowledge://la-roue-du-canape.md",
        content: include_str!("../../knowledge/atrium/la-roue-du-canape.md"),
    },
    KnowledgeDocument {
        title: "Le coussin piège",
        source: "knowledge://le-coussin-piege.md",
        content: include_str!("../../knowledge/atrium/le-coussin-piege.md"),
    },
    KnowledgeDocument {
        title: "Propulseur du canapé",
        source: "knowledge://propulseur-du-canape.md",
        content: include_str!("../../knowledge/atrium/propulseur-du-canape.md"),
    },
    KnowledgeDocument {
        title: "Cherche des potes",
        source: "knowledge://cherche-des-potes.md",
        content: include_str!("../../knowledge/atrium/cherche-des-potes.md"),
    },
    KnowledgeDocument {
        title: "Le coin des guides",
        source: "knowledge://le-coin-des-guides.md",
        content: include_str!("../../knowledge/atrium/le-coin-des-guides.md"),
    },
    KnowledgeDocument {
        title: "Les bonnes idées",
        source: "knowledge://les-bonnes-idees.md",
        content: include_str!("../../knowledge/atrium/les-bonnes-idees.md"),
    },
    KnowledgeDocument {
        title: "Les nouvelles du canapé",
        source: "knowledge://les-nouvelles-du-canape.md",
        content: include_str!("../../knowledge/atrium/les-nouvelles-du-canape.md"),
    },
    KnowledgeDocument {
        title: "Confessions",
        source: "knowledge://confessions.md",
        content: include_str!("../../knowledge/atrium/confessions.md"),
    },
    KnowledgeDocument {
        title: "Album du canapé",
        source: "knowledge://album-du-canape.md",
        content: include_str!("../../knowledge/atrium/album-du-canape.md"),
    },
    KnowledgeDocument {
        title: "Lofi music",
        source: "knowledge://lofi-music.md",
        content: include_str!("../../knowledge/atrium/lofi-music.md"),
    },
    KnowledgeDocument {
        title: "Sieste AFK",
        source: "knowledge://sieste-afk.md",
        content: include_str!("../../knowledge/atrium/sieste-afk.md"),
    },
];
...
// Recherche sémantique de la base de connaissances Atrium. Les documents sont
// découpés, vectorisés et recherchés par guilde ; un résultat vide ne constitue
// pas une réponse.
