...
fn prune_dto(o: platform_core::ops::domain::entities::docker_host::PruneOutcome) -> PruneResultDto {
    PruneResultDto {
        deleted: o.deleted,
...
fn prune_step(
    result: Result<
        platform_core::ops::domain::entities::docker_host::PruneOutcome,
        platform_core::ops::domain::errors::DomainError,
    >,
) -> PruneStepDto {
    match result {
        Ok(o) => PruneStepDto {
...
mod tests {
    ...
    use platform_core::ops::domain::entities::docker_host::PruneOutcome;
