...
use platform_proto::sentinel::progression::v1 as proto;
use platform_proto::sentinel::progression::v1::progression_service_server::ProgressionService;
use tonic::Request;
use tonic::Response;
use tonic::Status;
...
use platform_core::sentinel::ports::inbound::community::manage_levels::RecordActivityResult;
use platform_core::sentinel::ports::inbound::community::manage_levels::RecordTextActivityCommand;
use platform_core::sentinel::ports::inbound::community::manage_levels::RecordVoiceActivityCommand;
