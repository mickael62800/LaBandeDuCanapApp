...
use platform_core::ops::domain::entities::services_health::ServicesHealth;
...
impl From<platform_core::sentinel::domain::entities::moderation::action::applied::ModerationAction>
    for DashboardInfractionDto
{
    fn from(
        action: platform_core::sentinel::domain::entities::moderation::action::applied::ModerationAction,
    ) -> Self {
        Self {
