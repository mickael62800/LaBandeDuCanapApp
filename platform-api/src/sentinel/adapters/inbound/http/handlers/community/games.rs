...
use crate::sentinel::bootstrap::state::NexusGamesState;
...
) -> Result<&crate::sentinel::adapters::outbound::nexus_games::NexusGamesClient, ApiError> {
...
pub struct CoussinDto {
    pub profile: crate::sentinel::adapters::outbound::nexus_games::CoussinProfile,
    pub items: Vec<crate::sentinel::adapters::outbound::nexus_games::CoussinItem>,
    pub combats: Vec<crate::sentinel::adapters::outbound::nexus_games::CoussinCombat>,
    /// Classement de la guilde, pour situer le joueur.
    pub ranking: Vec<crate::sentinel::adapters::outbound::nexus_games::CoussinProfile>,
}
...
pub async fn wheel_cases(
    State(state): State<NexusGamesState>,
    user: Option<Extension<WebUser>>,
) -> Result<Json<crate::sentinel::adapters::outbound::nexus_games::WheelCases>, ApiError> {
    require_ctx(&user)?;
    let g = guild(&state)?;
