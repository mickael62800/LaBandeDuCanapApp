...
pub async fn list_all_channels(
    ...
    let limit =
        crate::sentinel::adapters::inbound::http::helpers::normalize_limit(params.limit, 50, 500)
            as usize;
    let offset =
        crate::sentinel::adapters::inbound::http::helpers::normalize_offset(params.offset) as usize;
...
pub async fn list_history_channels(
    ...
    let limit =
        crate::sentinel::adapters::inbound::http::helpers::normalize_limit(params.limit, 100, 500);
    let channels = state
        .voice_channels_uc
...
pub async fn list_channel_events(
    ...
    let limit =
        crate::sentinel::adapters::inbound::http::helpers::normalize_in(params.limit, 200, 1, 1000);
