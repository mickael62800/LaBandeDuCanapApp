...
use platform_core::sentinel::ports::inbound::guild_backup::manage_snapshots::{
    SnapshotId, SnapshotSummary,
};
...
pub async fn store_snapshot(
    ...
    let quota = platform_core::sentinel::domain::entities::system::bot_config::cfg_u64(
        &state
            .bot_config_repo
            .get_config(
                &guild_id,
                platform_core::sentinel::domain::entities::system::bot_names::GUILD_BACKUP_BOT,
            )
            .await
            .unwrap_or_default(),
        "snapshot_quota",
        u64::from(
            platform_core::sentinel::application::guild_backup::manage_snapshots_service::MAX_SNAPSHOTS_PER_GUILD,
        ),
    ) as u32;
    let id = state
        .guild_snapshots_uc
