...
pub async fn execute_ban(
    ...
    let command =
        platform_core::sentinel::ports::inbound::moderation::manage_moderation::LogModerationCommand {
...
pub async fn execute_mute(
    ...
    let duration =
        platform_core::sentinel::domain::entities::moderation::review::manual::resolve_mute_duration(
            dto.duration,
        );
    state
        .discord_api
