...
fn discord_facts_or_none(
    ...
    has_mod_role: bool,
    has_admin_role: bool,
) -> Option<platform_core::sentinel::domain::entities::moderation::review::automod::ModeratorFacts>
{
    if source == "discord" {
        Some(
            platform_core::sentinel::domain::entities::moderation::review::automod::ModeratorFacts {
                is_admin,
