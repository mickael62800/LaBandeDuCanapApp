...
pub(crate) async fn log_review_sanction(
    moderation_uc: &std::sync::Arc<
        dyn platform_core::sentinel::ports::inbound::moderation::manage_moderation::ManageModerationUseCase,
    >,
    bot_config_repo: &std::sync::Arc<
        dyn platform_core::sentinel::ports::outbound::system::bot_config_repository::BotConfigRepository,
    >,
    broadcaster: &std::sync::Arc<
        crate::sentinel::adapters::outbound::ws::broadcaster::EventBroadcaster,
    >,
    ...
    use platform_core::sentinel::domain::entities::moderation::review::automod::{
    ...
    let duration = if applied_action == "mute" {
        platform_core::sentinel::domain::entities::system::bot_config::cfg_str(
            &bot_config_repo
                .get_config(
                    review.guild_id.as_str(),
                    platform_core::sentinel::domain::entities::system::bot_names::AUTOMOD_BOT,
                )
                .await
                .unwrap_or_default(),
            "mute_duration_secs",
