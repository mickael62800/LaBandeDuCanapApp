...
use crate::sentinel::adapters::inbound::http::dto::system::tickets::AssignDto;
use crate::sentinel::adapters::inbound::http::dto::system::tickets::CreateTicketDto;
use crate::sentinel::adapters::inbound::http::dto::system::tickets::ListTicketsQuery;
use crate::sentinel::adapters::inbound::http::dto::system::tickets::ReplyDto;
use crate::sentinel::adapters::inbound::http::dto::system::tickets::TicketDetailDto;
use crate::sentinel::adapters::inbound::http::dto::system::tickets::TicketResponseDto;
use crate::sentinel::adapters::inbound::http::dto::system::tickets::UpdateStatusDto;
use crate::sentinel::adapters::inbound::http::dto::system::tickets::UpdateTicketChannelDto;
...
use platform_core::sentinel::domain::enums::system::ticket_status::TicketStatus;
...
pub async fn create_ticket(
    ...
    let mut command: platform_core::sentinel::ports::inbound::system::manage_tickets::CreateTicketCommand =
        dto.into();
