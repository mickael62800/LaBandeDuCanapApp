...
pub fn build_for_test(state: AppState) -> Router {
    let protected = Router::new()
        ...
        .route_layer(middleware::from_fn_with_state(
            state.clone(),
            crate::sentinel::adapters::inbound::http::middleware::superadmin::superadmin_middleware,
        ))
        .route_layer(middleware::from_fn_with_state(
            state.clone(),
            auth_middleware,
...
pub fn build(
    ...
    Router::new()
        ...
        .layer(middleware::from_fn_with_state(
            state.clone(),
            crate::sentinel::adapters::inbound::http::middleware::single_guild::single_guild_middleware,
        ))
        .layer(middleware::from_fn_with_state(
            logger_state,
