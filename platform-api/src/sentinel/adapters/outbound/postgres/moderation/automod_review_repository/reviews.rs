    ...
    pub(super) async fn create_or_merge_impl(
        ...
        if aggregate {
            ...
            if let Some(prev) = existing {
                ...
                let incident_action = platform_core::sentinel::domain::entities::moderation::review::automod::more_severe_suggested(
                    &prev.suggested_action,
                    r.suggested_action.as_str(),
                );
                let new_action = platform_core::sentinel::domain::entities::moderation::review::automod::more_severe_suggested(
                    &incident_action,
