...
use platform_core::sentinel::ports::inbound::system::manage_bot_persistence::ManageBotPersistenceUseCase;
use platform_core::sentinel::ports::inbound::system::manage_export_jobs::ManageExportJobsUseCase;
...
use platform_core::sentinel::ports::inbound::system::reset_guild::ResetGuildUseCase;
...
pub struct SystemState {
    ...
    // ── Exports ──
    pub export_uc:
        Arc<dyn platform_core::sentinel::application::system::export_service::ExecuteExportUseCase>,
