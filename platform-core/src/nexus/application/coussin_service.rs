...
impl CoussinService {
    ...
    async fn open_config(
        &self,
        guild_id: &str,
    ) -> Result<crate::nexus::application::economy_config::CoussinConfig, DomainError> {
...
impl CoussinProfileUseCase for CoussinService {
    ...
    async fn profile(
        ...
        let profile = CoussinProfile {
            ...
            title: crate::nexus::domain::entities::coussin::title_for_level(1).into(),
            total_wins: 0,
            total_losses: 0,
            total_draws: 0,
            total_stolen: 0,
    ...
    async fn choose_class(
        ...
        let hp_max = crate::nexus::domain::entities::coussin::max_hp_with(def, class, &cfg.classes);
        self.repo
            .update_class(
                guild_id,
                user_id,
...
impl CoussinCombatUseCase for CoussinService {
    async fn challenge(
        ...
        defender_name: &str,
        mise: i64,
    ) -> Result<crate::nexus::ports::outbound::coussin_repository::CoussinCombat, DomainError> {
        let cfg = self.open_config(guild_id).await?;
    ...
    async fn resolve(&self, id: uuid::Uuid) -> Result<bool, DomainError> {
        ...
        let result = crate::nexus::domain::entities::coussin::resolve_combat(
        ...
        let attacker_progress = if result.attacker_won.is_some() {
            ...
            let level =
                crate::nexus::domain::entities::coussin::level_for_xp_capped(xp, cfg.max_level);
            ...
            Some(CoussinProgress {
                ...
                level,
                stat_points,
                title: crate::nexus::domain::entities::coussin::title_for_level(level).into(),
            })
        } else {
            None
        };
