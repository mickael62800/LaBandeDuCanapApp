...
use crate::nexus::application::wallet_service::get_or_create_wallet;
use crate::nexus::domain::entities::wallet::Wallet;
use crate::nexus::domain::entities::wallet::WalletMutation;
use crate::nexus::domain::entities::wheel::default_cases;
use crate::nexus::domain::entities::wheel::is_memorable_case;
use crate::nexus::domain::entities::wheel::spin_cases_with_rng;
...
use crate::nexus::ports::inbound::play_wheel::PlayWheelResult;
...
impl PlayWheelUseCase for PlayWheelService {
    ...
    async fn can_spin(&self, guild_id: &str, user_id: &str) -> Result<bool, DomainError> {
        let cfg =
            crate::nexus::application::economy_config::load_economy(&self.config_repo, guild_id)
                .await?;
        if !cfg.enabled || !cfg.wheel_enabled {
            return Ok(false);
        }
